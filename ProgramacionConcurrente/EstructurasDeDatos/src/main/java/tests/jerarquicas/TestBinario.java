...
public class TestBinario {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("                                               [10]                                                      ");
        System.out.println("Ancestros de 3: Debe ser [9, 10] --> " + a.obtenerAncestros(3));
        System.out.println("Ancestros de 15: Debe ser [15, 10] --> " + a.obtenerAncestros(20));
        System.out.println("Ancestros de 0: Debe ser lista vacía --> " + a.obtenerAncestros(0));
        System.out.println("Ancestros de 10 (raiz): Debe ser lista vacía --> " + a.obtenerAncestros(10));
        a.vaciar();
        System.out.println("Ancestros de árbol vacío: Debe ser lista vacía --> " + a.obtenerAncestros(0));
